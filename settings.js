...
const DEFAULT_IMAGE_PATH = path.join(__dirname, 'assets', 'default-menu.jpeg');
...
module.exports = {
  ...
  BOT_NAME: getConfig("BOT_NAME") || process.env.BOT_NAME || "vortex",
  MODE: getConfig("MODE") || process.env.MODE || "private",
  REPO: process.env.REPO || "https://github.com/mxgamecoder/vortex",
  ...
  ALIVE_IMG: getConfig("ALIVE_IMG") || process.env.ALIVE_IMG || DEFAULT_IMAGE_PATH,
  LIVE_MSG: process.env.LIVE_MSG || "> ʙᴏᴛ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\n> ɢɪᴛʜᴜʙ :* github.com/mxgamecoder/vortex",
  ...
  MENU_IMAGES: {
    '1': process.env.DOWNLOAD_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '2': process.env.GROUP_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '3': process.env.FUN_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '4': process.env.OWNER_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '5': process.env.AI_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '6': process.env.ANIME_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '7': process.env.CONVERT_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '8': process.env.OTHER_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '9': process.env.REACTION_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '10': process.env.MAIN_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '11': process.env.LOGO_MAKER_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '12': process.env.SETTINGS_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '13': process.env.AUDIO_MENU_IMAGE || DEFAULT_IMAGE_PATH,
    '14': process.env.PRIVACY_MENU_IMAGE || DEFAULT_IMAGE_PATH
  }
};

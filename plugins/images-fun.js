...
async (malvin, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await malvin.sendMessage(from, { image: { url: data.message }, caption: '> made by vortex' }, { quoted: mek });
    } catch (e) {
        console.log(e);
...
async (malvin, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        await malvin.sendMessage(from, { image: { url: data[0].url }, caption: 'VORTEX CAT IMAGE 🐈\n\n> *made by vortex*' }, { quoted: mek });
    } catch (e) {
        console.log(e);
